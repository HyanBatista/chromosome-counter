...
@click.command()
@click.option("--source_dir", prompt="Source path", help="Path for the preprocessed/segmented image folder.")
@click.option("--output_file", prompt="Output file path", help="Path for the output file.")
